...
export const SocialPreviewOverlay = React.memo<SocialPreviewOverlayProps>(
  ({ platform, label, preview }) => {
    ...
    return (
      ...
      >
        <div
          className={`relative h-[220px] w-[360px] overflow-hidden rounded-[28px] border border-white/20 shadow-[0_35px_60px_rgba(0,0,0,0.5)] transition duration-200 group-focus-within:shadow-[0_38px_80px_rgba(0,0,0,0.45)] group-hover:shadow-[0_38px_80px_rgba(0,0,0,0.45)] ${isResume ? "bg-neutral-800" : "bg-neutral-900"
            }`}
        >
