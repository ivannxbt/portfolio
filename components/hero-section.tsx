  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-800/30 bg-gradient-to-b from-slate-900/70 to-slate-950 p-8 sm:p-12">
      <div className="animate-fade-in-up max-w-3xl">
        ...
        <p className="mt-4 text-sm tracking-[0.2em] text-teal-300 uppercase">
          {copy.availability}
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Button asChild size="lg">
            <a
              href="/CV.pdf"
              download
              className="inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-3 text-sm font-semibold tracking-[0.3em] text-white uppercase transition hover:border-white hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50"
            >
      ...
      <div
        className="animate-fade-in-up mt-12 grid gap-4 sm:grid-cols-3"
      ...
      >
        {copy.metrics.map((metric) => (
          ...
          >
            ...
            <p className="mt-2 text-sm tracking-[0.2em] text-slate-500 uppercase">
              {metric.label}
            </p>
          </div>
        ))}
