...
/**
 * Root metadata with global defaults.
 * Following performance preferences, we use a static object here to avoid
 * server-side data fetches on the root layout, which affects every page.
 * Localized metadata is managed in sub-layouts like app/[lang]/layout.tsx.
 */
